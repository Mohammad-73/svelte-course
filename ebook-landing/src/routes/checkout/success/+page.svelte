...
<HeroSection>
  ...
  <p class="light-grey mb-s">
    ...
    journey to Spain. We're confident that the insights an advice contained in
    this ebook will save your time, money, and unnecessary stress as you plan
    your move.
  </p>
  <p class="light-grey mb-s">
  ...
  <p class="light-grey">
    We're here to support your every step of the way. If you have any questions
